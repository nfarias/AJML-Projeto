...
public class GeradorArvore
{
    ...
    private /*@ spec_public nullable @*/ UnionFind unionFind;
    private /*@ spec_public nullable @*/ CriadorVetores vetor;
    private /*@ spec_public nullable @*/ Arvore tree;
    private /*@ spec_public nullable @*/ ArrayList < Arvore > floresta;
    private /*@ spec_public nullable @*/ GerenciadorArquivoOut arq;
